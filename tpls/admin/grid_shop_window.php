		...
		<div id="a_main_<?php echo $this->name_id?>" style="height:<?php echo $tab_height?>px;" class="a-tab">
			<table class="a-form" cellspacing="0">
				...
				<tr>
					...
					<td class="a-l" width="15%"><?php echo lang('$Start-Expires:')?></td><td class="a-r" width="35%"><input type="text" class="a-input a-date" style="width:100px" name="data[starts]" value="<?php echo $this->post('starts')?>" /> - <input type="text" class="a-input a-date" style="width:100px" name="data[expires]" value="<?php echo $this->post('expires')?>" /></td>
				</tr>
				<tr>
					<td class="a-l"><?php echo lang('$Type:')?></td><td class="a-r" width="35">
						<select name="data[type]"><option value=""></option><?php echo Data::getArray('my:voucher_types',$this->post('type', false));?></select>
					</td>
					<td class="a-l" width="15%"><?php echo lang('$Percentage:')?></td><td class="a-r" width="35%"><input type="text" class="a-input" style="width:100px" name="data[perc]" value="<?php echo $this->post('perc')?>" /></td>
				</tr>
			</table>
		</div>
