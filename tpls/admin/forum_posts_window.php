...
* 
* @file       tpls/admin/forum_posts_window.php
...
var window_<?php echo $this->name_id?> = {
	...
	,load:function() {
		...
		<?php $this->inc('js_editors', array('body'=>365))?>
	}
...
?><form method="post" class="window_form" id="a-form_<?php echo $this->name_id?>">
	...
	<tr></table><table class="a-form ui-corner-all" cellspacing="0"><td class="a-r" colspan="2">
		<textarea type="text" class="a-textarea" name="data[descr]" id="a-w-body_<?php echo $this->name_id?>" style="width:99%;height:340px;visibility:hidden"><?php echo $this->post('descr')?></textarea>
	</td></tr></table>
