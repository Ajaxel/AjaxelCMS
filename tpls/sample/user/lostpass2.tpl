...
<form class="form ajax_form" method="post" action="?{$URL}" id="form">
	<table cellspacing="0"><tbody>
		...
		<tr class="bb">
			<th{if $form_errors.login} class="err"{/if}><div style="width:170px">{'Enter your new password'|lang}<span class="ast">*</span>:</div></th>
		...
		<tr>
			<td colspan="4" class="b">
				<button type="submit" class="reg_button bg x">{'_Save password'|lang}<span class="x">{'Save password'|lang}</span></button>
			</td>
		</tr>
	</tbody></table>
