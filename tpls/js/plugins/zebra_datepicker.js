 ...
 *  @version    1.0 (last revision: May 27, 2011)
...
(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var view, datepicker, icon, header, daypicker, monthpicker, yearpicker, current_system_month, current_system_year,
            ...
            selected_year, default_day, default_month, default_year, disabled_dates, shim, direction;
        ...
        plugin.init = function() {
            ...
            direction =
                ...
                // future-only
                (plugin.settings.direction === true || to_int(plugin.settings.direction) > 0) ? true :

                // past-only
                ((plugin.settings.direction === false || to_int(plugin.settings.direction) < 0) ? false :
            ...
            if (direction !== 0) {
                ...
                date = new Date(
                    ...
                    first_selectable_day + to_int(plugin.settings.direction)
                );
            ...
            // attach the click event to the calendar icon
            ...
            datepicker.delegate('td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month, .dp_blocked)', {
                'mouseover': function() {
            ...
            daypicker.delegate('td:not(.dp_disabled, .dp_weekend_disabled, .dp_not_in_month)', {
