...
function CheckAuthentication()
{
	...
	return isset($_SESSION['RIGHTS']['filebrowser']) && $_SESSION['RIGHTS']['filebrowser'];
...
*/
$config['RoleSessionVar'] = 'UserRole';
//session_start();
...
$config['ResourceType'][] = array(
		...
		'maxSize' => "16M",
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,avi,mpg,mpeg,mp3',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = array(
		'name' => 'Icons',				// Single quotes not allowed
		'url' => '/tpls/img',
		'directory' => '',
		'maxSize' => 0,
		'allowedExtensions' => '',
...
if ($_SESSION['RIGHTS']['template']) {
	$config['ResourceType'][] = array(
			'name' => 'Template ['.$_SESSION['RIGHTS']['template'].']',
			'url' => '/tpls/'.$_SESSION['RIGHTS']['template'],
			'directory' => '',
			'maxSize' => 0,
			'allowedExtensions' => '',
			'deniedExtensions' => '');
	if ($_SESSION['RIGHTS']['files']) {
		$config['ResourceType'][] = array(
				'name' => 'Files ['.$_SESSION['RIGHTS']['template'].']',
				'url' => '/'.$_SESSION['RIGHTS']['files'],
				'directory' => '',
				'maxSize' => 0,
				'allowedExtensions' => '',
...
*/
$config['HtmlExtensions'] = array('html', 'htm', 'xml', 'js', 'tpl', 'css');
...
*/
$config['HideFolders'] = array('.svn', 'CVS','inc','mod','geo','temp','admin','_notes','config');
...
$config['plugin_imageresize']['mediumThumb'] = '160x120';
$config['plugin_imageresize']['largeThumb'] = '380x300';
