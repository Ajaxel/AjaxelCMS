CKFinder.addPlugin( 'fileeditor', function( api ) {
	var regexExt = /^(.*)\.([^\.]+)$/,
		regexTextExt = /^(txt|css|html|htm|js|asp|cfm|cfc|ascx|php|inc|xml|xslt|xsl|tpl)$/i,
		regexCodeMirrorExt = /^(css|html|htm|js|xml|xsl|php|tpl)$/i,
		codemirror,
		file,
		fileLoaded = false,
		doc;
	...
	var codeMirrorParsers = {
		css : 'parsecss.js',
		js : [ 'parsejavascript.js', 'tokenizejavascript.js' ],
		xml : 'parsexml.js',
		php : ['parsexml.js', '../contrib/php/js/tokenizephp.js', '../contrib/php/js/parsephp.js', '../contrib/php/js/parsephphtmlmixed.js'],
		tpl : 'parsexml.js',
		html : ['parsexml.js', 'parsecss.js', 'tokenizejavascript.js', 'parsejavascript.js']
	};
	var codeMirrorCss = {
		css : codemirrorPath + 'css/csscolors.css',
		js : codemirrorPath + 'css/jscolors.css',
		xml : codemirrorPath + 'css/xmlcolors.css',
		tpl : codemirrorPath + 'css/xmlcolors.css',
		...
		html : [ codemirrorPath + 'css/xmlcolors.css', codemirrorPath + 'css/jscolors.css', codemirrorPath + 'css/csscolors.css', codemirrorPath + 'contrib/php/css/phpcolors.css' ]
	};
