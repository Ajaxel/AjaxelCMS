...
//      }
  ...
  private static function tempnam($tmp, $name) {
	 return tempnam(FTP_DIR_ROOT.'files/temp/',$name);  
  }
  protected function addImagePngAlpha($file, $x, $y, $w, $h, $byte) {
    ...
    $tempfile_alpha = self::tempnam($this->tmp, "cpdf_img_");
    @unlink($tempfile_alpha);
    $tempfile_alpha = "$tempfile_alpha.png";

    // create temp plain file
    $tempfile_plain = self::tempnam($this->tmp, "cpdf_img_");
