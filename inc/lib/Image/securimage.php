...
class Securimage {
   ...
   */
  var $wordlist_file = './config/system/words.txt';
   ...
   * @var mixed
   */
  var $gd_font_file = './config/fonts/gdfonts/bubblebath.gdf';
   ...
   * @var string
   */
  var $ttf_file = "./config/fonts/comic.ttf";
   ...
   * @var string
   */
  var $multi_text_color = "#0a68dd,#f65c47,#8d32fd,#006666,#00CC00";
  ...
  function saveData()
  {
    $_SESSION['Captcha_sessioncode'] = strtolower($this->code);
  }
  ...
  function validate()
  {
    if ( isset($_SESSION['Captcha_sessioncode']) && !empty($_SESSION['Captcha_sessioncode']) ) {
      if ( $_SESSION['Captcha_sessioncode'] == strtolower(trim($this->code_entered)) ) {
        $this->correct_code = true;
        $_SESSION['Captcha_sessioncode'] = '';
      } else {
  ...
  {
    if (isset($_SESSION['Captcha_sessioncode']) && !empty($_SESSION['Captcha_sessioncode'])) {
      return $_SESSION['Captcha_sessioncode'];
    } else {
      return '';
    }
  }
