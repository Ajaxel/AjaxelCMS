...
class Mobile_Detect
{
    ...
    */
    ...
    public function mobileGrade()
    {
        ...
        if (
            $this->version('iPad', self::VERSION_TYPE_FLOAT)<4.3 && !$isMobile ||
            $this->version('iPhone', self::VERSION_TYPE_FLOAT)<3.1 && !$isMobile ||
            $this->version('iPod', self::VERSION_TYPE_FLOAT)<3.1 && !$isMobile ||
